// yo can remove lodash i you want lodash was used in case where we had to write the name of our post/blog in the search bar (google search bar) but as we are using readmore as a link to the page of post you do not need the lodash any more
